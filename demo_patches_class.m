...
CNM.gnb = gnb;
CNM.K = K;
CNM.patch_size = [32,32];                   % size of each patch along each dimension (optional, default: [32,32])
CNM.overlap = [6,6];                        % amount of overlap in each dimension (optional, default: [4,4])
