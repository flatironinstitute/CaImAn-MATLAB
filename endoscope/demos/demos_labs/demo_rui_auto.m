...
sframe=1000;						% user input: first frame to read (optional, default:1)
...
for miter=1:3
    ...
    thresh = 8;     % threshold for detecting large cellular activity in each pixel. (mean + thresh*sn)
