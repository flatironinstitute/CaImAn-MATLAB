...
if ~isfield(params,'min_size'); min_size = 8; else min_size = params.min_size; end    % minimum size of ellipse axis 
if ~isfield(params,'max_size'); max_size = 3; else max_size = params.max_size; end    % maximum size of ellipse axis
if ~isfield(params,'dist'); dist = 3; else dist = params.dist; end                              % expansion factor of ellipse
if ~isfield(params,'se'); expandCore = strel('disk',4,0); else expandCore = params.se; end      % morphological element (for 'dilate')
